    ...
    >
      ...
      <div className="text-center py-4 bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-xl mb-4">
        <motion.div
          ...
          className="text-[2.4rem] font-extrabold text-emerald-700 tracking-tight leading-none"
        >
          ${total.toLocaleString()}
        </motion.div>
        <div className="text-[0.72rem] text-emerald-600 font-medium mt-1 flex items-center justify-center gap-1">
      ...
      <div className="space-y-3 mb-4">
        {bars.map((bar, i) => (
          <div key={bar.label} className="flex items-center gap-3">
            <span className="text-[0.72rem] font-medium text-gray-500 w-[110px] shrink-0">{bar.label}</span>
            <div className="flex-1 h-7 bg-gray-100 rounded-md overflow-hidden relative">
              ...
              >
                <span className="text-[0.68rem] font-semibold text-white whitespace-nowrap">
      ...
      <button
        ...
        className="w-full py-2.5 rounded-lg bg-indigo-50 border border-indigo-200 text-indigo-600 text-[0.78rem] font-semibold hover:bg-indigo-100 transition-all duration-200 flex items-center justify-center gap-2"
      >
